...
switch ($_POST['form_type']) {
	case 'event':
		$replay_txt = get_theme_mod('event_mail_auto_reply', 'default_value');
		$thanks_url = get_theme_mod('event_thanks_page', 'default_value');
		$thanks_url = $thanks_url . '/event-form-thanks/';
		break;
	case 'contact':
		$replay_txt = get_theme_mod('contact_form_section_auto_reply', 'default_value');
		$thanks_url = $thanks_url . '/contact-form-thanks/';
		break;
	case 'appying_form':
		$replay_txt = get_theme_mod('applying_form_section_auto_reply', 'default_value');
		$thanks_url = $thanks_url . '/applying-form-thanks/';
		break;
	default:
		$replay_txt = '';
		$thanks_url = '';
